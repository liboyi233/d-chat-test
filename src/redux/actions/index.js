...
// 设置阅后即焚时间
export const setBurnAfterReadingTime = burnTime => ({
	type: 'chat/SET_BURN_AFTER_READING_TIME',
	payload: burnTime
});

// 将设置了阅后即焚消息的联系人添加到一个列表
export const addBurnAfterReadingContact = burnContactList => ({
	type: 'chat/ADD_BURN_AFTER_READING_CONTACT',
	payload: burnContactList
});
